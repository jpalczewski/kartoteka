...
pub fn drag_surface_class(is_dragged: bool) -> &'static str {
    if is_dragged {
        "flex-1 rounded-[1.35rem] ring-2 ring-primary/20 shadow-2xl transition-all duration-200"
    } else {
...
pub fn drop_marker_class(is_active: bool) -> &'static str {
    if is_active {
...
pub fn drop_marker_line_class(is_active: bool) -> &'static str {
    if is_active {
...
pub fn drop_marker_label_class(is_active: bool) -> &'static str {
    if is_active {
