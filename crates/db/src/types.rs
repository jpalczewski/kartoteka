...
mod tests {
    ...
    async fn flex_date_roundtrip_day() {
        ...
        sqlx::query("INSERT INTO lists (id, user_id, name) VALUES ('l1', 'u1', 'test')")
            ...
            .unwrap();
        sqlx::query(
            "INSERT INTO items (id, list_id, title, start_date) VALUES ('i1', 'l1', 'test', ?)",
        )
        .bind(&date)
        .execute(&pool)
        .await
    ...
    async fn flex_date_roundtrip_week() {
        ...
        sqlx::query("INSERT INTO lists (id, user_id, name) VALUES ('l1', 'u1', 'test')")
            ...
            .unwrap();
        sqlx::query(
            "INSERT INTO items (id, list_id, title, deadline) VALUES ('i1', 'l1', 'test', ?)",
        )
        .bind(&date)
        .execute(&pool)
        .await
    ...
    async fn flex_date_roundtrip_month() {
        ...
        sqlx::query("INSERT INTO lists (id, user_id, name) VALUES ('l1', 'u1', 'test')")
            ...
            .unwrap();
        sqlx::query(
            "INSERT INTO items (id, list_id, title, hard_deadline) VALUES ('i1', 'l1', 'test', ?)",
        )
        .bind(&date)
        .execute(&pool)
        .await
    ...
    async fn user_row_from_db() {
        let pool = test_pool().await;
        sqlx::query(
            "INSERT INTO users (id, email, name, role) VALUES ('u1', 'a@b.com', 'Alice', 'admin')",
        )
        .execute(&pool)
        .await
        .unwrap();
