...
mcp-tool-add_comment-desc = Dodaj komentarz do elementu, listy lub kontenera. Ustaw author_name aby oznaczyć autora — np. "Claude" dla notatek AI, lub pomiń aby przypisać do zalogowanego użytkownika.
