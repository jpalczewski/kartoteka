...
mcp-tool-add_comment-desc = Add a comment to an item, list, or container. Set author_name to identify who wrote it — e.g. "Claude" for AI-generated notes, or omit to attribute to the logged-in user.
