...
WORKDIR /app
COPY crates/frontend/package.json crates/frontend/
COPY crates/frontend/style/ crates/frontend/style/
...
WORKDIR /app
COPY . .
COPY --from=css-builder /app/crates/frontend/style/main.css crates/frontend/style/main.css
